...
const CustomizeArrow = () => {
    ...
    return (
        <div>
            ...
            <p>
                {' '}
                This example shows some of the main API options. give the arrow diffrent properties to customize his
                look. note
                that some options are cannot be changed though this GUI(like custom lables or advande dashness and more)
                play
            ...
            {showMe ? (
                <div>
                    ...
                    <MyCollapsible title={'arrow apearance'} open={true}>
                        <Div>
                            <p>arrow color(all): </p>
                            <select style={{height: '20px', marginRight: 10}}
                        ...
                        <Div>
                            ...
                            />
                            <p>animation: </p>
                            <NumericInput value={animation} onChange={(val) => setAnimation(val)}
                                          style={{input: {width: 60}}}/>
                            <p>dashed: </p>
                            <input
                                style={{height: '15px', width: '15px'}}
                        ...
                        <Div>
                            <p>Relation Type: </p>
                            <div>
                                <p>Начнется после окончания (ОН):
                                    <input
                                        style={{height: '15px', width: '15px'}}
                                        type="checkBox"
                                        checked={relationType === RELATION_TYPES.oh}
                                        onChange={(e) => {
                                            setRelationType(RELATION_TYPES.oh);
                                        }}
                                    />
                                </p>

                                <p>Окончится после начала (НО):
                                    <input
                                        style={{height: '15px', width: '15px'}}
                                        type="checkBox"
                                        checked={relationType === RELATION_TYPES.ho}
                                        onChange={(e) => {
                                            setRelationType(RELATION_TYPES.ho);
                                        }}
                                    />
                                </p>

                                <p>Начнется после начала (НН):
                                    <input
                                        style={{height: '15px', width: '15px'}}
                                        type="checkBox"
                                        checked={relationType === RELATION_TYPES.hh}
                                        onChange={(e) => {
                                            setRelationType(RELATION_TYPES.hh);
                                        }}
                                    />
                                </p>

                                <p>Окончится до окончания (ОО):
                                    <input
                                        style={{height: '15px', width: '15px'}}
                                        type="checkBox"
                                        checked={relationType === RELATION_TYPES.oo}
                                        onChange={(e) => {
                                            setRelationType(RELATION_TYPES.oo);
                                        }}
                                    />
                                </p>
